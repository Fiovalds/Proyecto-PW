                ...
                <div className="pregunta">
                    <div className="row ms-4 me-4 mt-2">
                        ...
                        <div className="col-8">
                            ...
                            <nav className="text-end pt-3"><a className="link" href="" data-bs-toggle="modal" data-bs-target="#exampleModal2"># respuestas</a></nav>
                            <div className="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div className="modal-dialog modal-dialog-centered">
                                    <div className="modal-content">
                                        <div className="modal-header">
                                            <h2 className="modal-title offset-4" id="exampleModalLabel">Respuestas</h2>
                                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div className="modal-body">
                                            {ArmarListaRespuestas(props.preguntas[0])}
